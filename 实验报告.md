...
3. 郑仁哲部分：
   ...
   var x = 1 + 2i 
    ...
    结果
    ```
   [{'assign_stmt': {'target': 'r', 'operand': "''a''"}},
   {'variable_decl': {'attr': [], 'data_type': 'const', 'name': 'first'}},
   {'assign_stmt': {'target': 'first', 'operand': 'r'}},
   {'assign_stmt': {'target': '%v0',
                  'operator': '+',
                  'operand': '1',
                  'operand2': '2'}},
   {'assign_stmt': {'target': 'x', 'operand': '%v0'}}]
   [{'operation': 'assign_stmt', 'stmt_id': 1, 'target': 'r', 'operand': "''a''"},
   {'operation': 'variable_decl',
   'stmt_id': 2,
   'attr': None,
   'data_type': 'const',
   'name': 'first'},
   {'operation': 'assign_stmt', 'stmt_id': 3, 'target': 'first', 'operand': 'r'},
   {'operation': 'assign_stmt',
   'stmt_id': 4,
   'target': '%v0',
   'operator': '+',
   'operand': '1',
   'operand2': '2'},
   {'operation': 'assign_stmt', 'stmt_id': 5, 'target': 'x', 'operand': '%v0'}]
    ```
